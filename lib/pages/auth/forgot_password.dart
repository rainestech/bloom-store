    ...
    try {
      ...
      if (_response.error.length > 0) {
       EasyLoading.dismiss();
        ...
        EasyLoading.dismiss();
        EasyLoading.showSuccess('Reset Instructions sent to your email. Please check for OTP code', maskType: EasyLoadingMaskType.black, duration: Duration(seconds: 10));

        Navigator.push(
            context,
            PageTransition(
                type: PageTransitionType.rightToLeft,
                child: OtpScreen(2, _response, _email)));
      }
    } catch (error) {
      EasyLoading.dismiss();
